...
void	add_ui_textures(t_data *data)
{
	...
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_0_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_1_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_2_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_3_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_4_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_5_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_6_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_7_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_8_TXT_PATH), data);
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_9_TXT_PATH), data);	
	add_texture_node(ID_CHEST_UI, ft_strdup(UI_BAR_TXT_PATH), data);
}
...
void	print_ui(t_data *data)
{
	...
	//print_ui_sprite(pos, ID_CHEST_SHDW_UI, data);
	print_num_sprite(pos, data->map_data->chest_found, data); //CHESTS FOUND
	print_ui_sprite(pos, ID_CHEST_UI, data); //TODO BAR
